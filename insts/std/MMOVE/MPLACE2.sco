...
MPLACE(outsk+3,insk,dur,pre_amp,-10,dist_front-4,dist_mikes,inchan);
MPLACE(outsk+6,insk,dur,pre_amp,10,dist_front-4,dist_mikes,inchan);

RVB(0, 0, outsk+6+dur+rvbtime, 0.4);

/* LOCALIZE2D - localize sound source
		-- just like LOCALIZE only without the "z" (height) calculation (2D only)
...
#include <stdlib.h>
#include <ugens.h>
#include "LOCALIZE2D.h"          // declarations for this instrument class
#include <rt.h>
#include <rtdefs.h>


// constructor
LOCALIZE2D::LOCALIZE2D()
{
}
...
int LOCALIZE2D::init(double p[], int n_args)
{
	float mult;
	int flipper;
...
Instrument *makeLOCALIZE2D()
{
	LOCALIZE2D *inst = new LOCALIZE2D();
	inst->set_bus_config("LOCALIZE2D");

// Stk.C -- hacked version (by BGG) for RTcmix from Perry/Gary's STK
//      a lot of the Stk functions we don't use in RTcmix, so they
//      haven't really been 'fixed' to work in RTcmix

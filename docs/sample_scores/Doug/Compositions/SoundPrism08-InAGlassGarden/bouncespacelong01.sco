...
while (offset < totallength) {
	...
	sFudgeDiff  = pickrand(-400, -312, -254, -213, -472, -513) + 200;
	...
	while (start - offset < ldur) {
		nextstart = start + irand(0.05, 0.25);		// time for next glass call

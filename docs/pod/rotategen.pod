...
rotategen - change the phase of a function table

=head1 SYNOPSIS

B<rotategen>(I<table_number>, I<rotate>)

=head1 DESCRIPTION

Call B<rotategen> from a script to rotate the elements of a function table,
shifting the phase of the table.

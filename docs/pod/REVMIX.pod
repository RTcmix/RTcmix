...
=item B<p5> (I<stereoloc>) percent (from 0 to 1) of input signal to place
...
Ivica "Ico" Bukvic E<lt>ico@fuse.netE<gt>

(with John Gibson E<lt>johgibso@indiana.eduE<gt>)

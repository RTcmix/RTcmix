...
If I<filename> doesn't exist, B<sfcreate> creates a new file with the
specified soundfile header.  If I<filename> already exists,
...
I<filename> argument, B<sfcreate> just prints a help summary.
...
Use I<NUM> number of channels.  The default is 2.
...
Use the sampling rate given by I<NUM>.  44100 is the default.
...
John Gibson E<lt>johgibso@indiana.eduE<gt>, based on the original
